...
internal static class LteCore
{
    ...
    )
    {
        ...
        foreach (Match match in matches)
        {
            ...
            string funDepends = wildcardValueSplit.ElementAtOrDefault(1) ?? "��Ʒ���";
    ...
    )
    {
        funDy1 = string.IsNullOrEmpty(funDy1) ? "2" : funDy1;
        funDy2 = string.IsNullOrEmpty(funDy2) ? "00" : funDy2;
        funDy3 = string.IsNullOrEmpty(funDy3) ? "�������ֵ" : funDy3;
    ...
    )
    {
        ...
        Debug.Print($"Mer: �޷��� '{dependsValue}' ����Ϊ long ���͡�");
        return dependsValue;
    }
    ...
    {
        funDy1 = string.IsNullOrEmpty(funDy1) ? "�������ֵ" : funDy1;
        if (!exportWildcardDyData.TryGetValue(funDepends, out var dependsValue))
            return string.Empty;
    ...
    {
        funDy1 = string.IsNullOrEmpty(funDy1) ? "��������" : funDy1;
    ...
    {
        funDy1 = string.IsNullOrEmpty(funDy1) ? "��Ʒ���" : funDy1;
    ...
    {
        funDy1 = string.IsNullOrEmpty(funDy1) ? "1" : funDy1;
        funDy2 = string.IsNullOrEmpty(funDy2) ? "����ID��" : funDy2;
        funDy3 = string.IsNullOrEmpty(funDy3) ? "��������" : funDy3;
        ...
        {
            Debug.Print($"CollectRow: �޷��� '{dependsVal}' ����Ϊ long ���͡�");
            return dependsVal;
        }
